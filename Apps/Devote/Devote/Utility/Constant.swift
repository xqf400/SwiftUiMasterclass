...
var backgroundClear: LinearGradient{
    let color = UIColor(red: 0, green: 0, blue: 0, alpha: 0)
    return LinearGradient(gradient: Gradient(colors: [Color(color), Color(color)]), startPoint: .topLeading, endPoint: .bottomTrailing)
}
